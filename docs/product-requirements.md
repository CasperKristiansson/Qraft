...
- Existing top-level checklists work with or without H2 sections. Read-only indented task instructions appear in details. Unsupported nesting is explained rather than silently treated as reviewable tasks.
